...
print("졸음 감지 시스템 시작. 종료하려면 q를 누르세요.")
...
while True:
    ...
    # 졸음 판정
    # =========================
    if face_detected and current_ear < 0.22:
    ...
    if not face_detected:
        ...
        cv2.putText(frame, f"EAR: {current_ear:.3f}", (30, 130),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2)

    else:
        cv2.putText(frame, f"EAR: {current_ear:.3f}", (30, 50),
